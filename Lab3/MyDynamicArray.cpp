...
void display(const DynamicArray<double>&, const DynamicArray<bool>&, int);

int main()
{
  DynamicArray<double> index;
  DynamicArray<bool> index2;
  int numbers =0;
  string buf1;
  string buf2;
  string buf3;
...
void display(const DynamicArray<double>& index, const DynamicArray<bool>& index2, int pos)
{
